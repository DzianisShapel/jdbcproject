...
public class DBConnection {
    ...
    private static PreparedStatement pr_stmt = null;
    ...
    public static void dropTable(String tableName) {
        ...
        try {
            pr_stmt = connectToDB().prepareStatement(query);
            Log.info("Send request to DB: " + query);
            pr_stmt.executeUpdate(query);
    ...
    private static void addSQLRequestResultsToLog(String query) throws SQLException {
